...
@store2.employees.create(first_name: "Steven", last_name: "Tyler", hourly_rate: 32)
@store2.employees.create(first_name: "Megan", last_name: "Jones", hourly_rate: 25)
@store2.employees.create(first_name: "Stacy", last_name: "West", hourly_rate: 80)
